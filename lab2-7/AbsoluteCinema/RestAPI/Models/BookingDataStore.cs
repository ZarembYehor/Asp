...
namespace RestAPI.Models
{
    public static class BookingDataStore
    {
        ...
        public static int RemoveBookings(IEnumerable<Seat> seatsToRemove)
        {
            int initialCount = PermanentBookedSeats.Count;

            PermanentBookedSeats.RemoveAll(bookedSeat =>
                seatsToRemove.Any(s => s.Row == bookedSeat.Row && s.Number == bookedSeat.Number));

            return initialCount - PermanentBookedSeats.Count;
        }
    }
